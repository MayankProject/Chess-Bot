...
def decideBoardAndSetConfigs():
    ...
    global board, Turn
    #Default boards to recognise intial state and decide from which pieces you are playing
    ...
    for sample_piece in all_sample_pieces:
        ...
        for piece in pg.locateAllOnScreen(f'sprites/{sample_piece}.png', confidence=confidence):
            ...
            for singlePiece in all_pieces:
                ...
                if (
                    piece.left-40<singlePiece.position['x'] and 
...
def setCords():
    ...
    for piece in all_pieces:
        ...
        # print(alpha_list, alpha_sno, num_list, num_sno)=
        print(piece.center, board.left, square_width)
...
all_sample_pieces = [
    ...
    {'sample_piece': 'BR', 'confidence': 0.5},
    # -------------------------------------
    {'sample_piece': 'WQ', 'confidence': 0.5},
    {'sample_piece': 'WP', 'confidence': 0.5},
    {'sample_piece': 'WN2', 'confidence': 0.4},
    {'sample_piece': 'WK', 'confidence': 0.4},
    {'sample_piece': 'WB2', 'confidence': 0.4},
    {'sample_piece': 'WR2', 'confidence': 0.3},
]
